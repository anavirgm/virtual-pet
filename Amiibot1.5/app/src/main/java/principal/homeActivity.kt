...
class homeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val selectedImage = intent.getIntExtra("selectedImage", R.drawable.fuego)
        val selectedBackground = intent.getIntExtra("selectedBackground", R.drawable.fondo_fuego_1)
